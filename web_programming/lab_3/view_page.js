...
//         var card = event.target.parentElement; // Отримуємо батьківську карточку
//         var name = card.querySelector(".name").textContent; // Отримуємо дані з іменем
//         var price = card.querySelector(".priceId").textContent; // Отримуємо дані з ціною

//         console.log("Name:", name);
//         console.log("Price:", price);

//         // Тепер ви можете використовувати зміні name і price для подальшої роботи з ними.
//     });
// });